...
\begin{figure}[h]
    ...
    % TODO: add reference, who pointed out that trapdoor permutation is PCA secure
...
\begin{table}
    ...
    \end{tabular}
    % TODO: also add references in the table
...
% TODO: reference attacks on MAC to show that it is harder to 
...
% TODO: move after code-based section
