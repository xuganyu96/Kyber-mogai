% >>>>>>> Feb 12, 2025
% eprint 2021/844 is a highly similar result to this paper, so we are no longer submitting to CRYPTO 2025. Perhaps in future works we can benchmark performance of TLS handshake using IND-1CCA secure KEM instead of IND-CCA secure KEM

% >>>>>>> Feb 11, 2025
% DONE: need summary table in contribution
% DONE: mention McEliece might be OW-PCA, but performance improvements are minor
% DONE: reference the network RTT appendix in the main body
% DONE: major re-write:
%   - [x] Remove the Classic McEliece section
%   - [x] Remove the ElGamal section, instead we will mention DHIES in Section 1.2
%   - [x] Re-instate ML-KEM and present encapsulation/decapsulation numbers; also include key exchange RTT in Appendix
